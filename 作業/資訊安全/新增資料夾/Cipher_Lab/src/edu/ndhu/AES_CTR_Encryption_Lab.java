...
public class AES_CTR_Encryption_Lab
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        byte[] cipherText = AES_CTR_Encryption.encrypt(plainText.getBytes(),key, IV);
        ...
        String decryptedText = AES_CTR_Encryption.decrypt(cipherText,key, IV);
